...
if __name__ == "__main__":
    ...
    # 캡처할 특정 영역 정의
    region = {"top": 225, "left": 1495,
              "width": 417, "height": 758}  # 모니터 좌표

    # 더 많은 워커로 병렬화 수준을 높여 속도 최적화
    continuously_find_and_click_in_region(
        template_path, region, threshold=0.9, num_workers=20)
